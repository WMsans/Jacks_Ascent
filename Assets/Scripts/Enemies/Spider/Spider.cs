...
public class Spider : MonoBehaviour
{
	public LayerMask raycastLayers; // The ground layers
		...
		public SpiderLeg[] legs; // All the legs of this spider
        ...
        void Update() {
			...
			*/
			...
			if (Physics.Raycast(transform.position + transform.up * raycastHeight * scale, -transform.up, out rootHit, (raycastHeight * scale) + (raycastDistance * scale), raycastLayers, QueryTriggerInteraction.Ignore)) {
